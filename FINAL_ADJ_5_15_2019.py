...
class ProxAlarm(Frame):
    ...
    def process(self, button):
       ...
       # back clears the last element in the display
        ...
        #arm button
            ...
            if (self.alarmGoingOff == True) and (self.user_input["text"] in self.codes):
    ...
    def program2(self):
        if (self.user_input["text"] != "000000"):
            #code list will be used to store our user's code
            new_code = self.user_input["text"]
            ...
            GPIO.cleanup()
            self.text_messages["text"] = "Goodbye, and stay safe!"
            self.text_messages.after(2000, self.quit)
    ...
    def arm(self):
        ...
        if (self.user_input["text"] in self.codes):
    ...
    def pir2(self):
        ...
        # LED switches from blue to yellow
